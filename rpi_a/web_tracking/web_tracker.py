...
from rpi_a.web_tracking.performance_meter import PerformanceMeter
...
class WebTracker:
    def __init__(
        ...
        self.pref_meter = PerformanceMeter('Web Tracker')
    ...
    def start(self):
        ...
        try:
            ...
            while True:
                with self.pref_meter.section("tracking"):
                    ...
                    # This will reset the counters when called
